...
- And from the **Invoice_item.csv** we should select the rows that match the invoice code field with the invoices previously selected for the invoice output file and write them down to an output file. 
